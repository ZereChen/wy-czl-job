package com.czl.order.init;

import com.czl.enumeration.order.ProcessReqEnum;
import com.czl.order.annotation.InjectProcessors;
import com.czl.order.annotation.PackageScan;
import com.czl.order.engine.ProcessEngine;
 ...
 */
@Component
@PackageScan("com.czl.order.engine.ProcessEngine")
